    ...
    <section id="inicio" className="hero">
      <div className="hero-content fade-in">
        ...
        <div className="hero-greeting">
          ...
          <h1 className="hero-hey">{t("hero.greeting")}</h1>
        </div>

        <div className="hero-info">
          <div className="info-badge">
            <span className="badge-accent">{t("hero.experience")}</span>{" "}
            {t("hero.experienceText")}
          </div>
          <div className="info-details">
            <span className="role">{t("hero.role")}</span>
            <span className="divider">•</span>
            <span className="location">{t("hero.location")}</span>
          </div>
        </div>

        <p className="hero-specialization">
          <Trans
            i18nKey="hero.specialization"
            components={[
              <span className="highlight-gradient" key="0"></span>,
              <span className="highlight-gradient" key="1"></span>,
            ]}
          />
        </p>
